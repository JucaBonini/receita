...
function renderizar_metabox_receita($post) {
    ...
    <div class="receita-metabox">
        ...
        <div class="metabox-section gan-prompt-helper" style="border: 1px dashed #ec5b13; background: #fffdfb; margin-bottom: 20px;">
            ...
            <p class="description">Clique no botão para copiar o prompt de redação com o título e a palavra-chave deste post configurados. Cole no ChatGPT ou Gemini e use as informações para preencher as seções abaixo.</p>
...
1. CONTEÚDO PRINCIPAL (Introdução da receita - 2 a 3 parágrafos envolventes focados em Ganho de Informação, explaining why the recipe works or what error it avoids):
