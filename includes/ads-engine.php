...
function sts_render_ad($slot_name, $classes = '') {
    ...
    if (strpos($slot_name, 'billboard') !== false || strpos($slot_name, 'above_title') !== false) $min_height = $is_mobile ? '100px' : '280px';
    if (strpos($slot_name, 'sidebar') !== false)   $min_height = '600px';
    if (strpos($slot_name, 'mid') !== false || strpos($slot_name, 'before_ingredients') !== false || strpos($slot_name, 'after_recipe') !== false) $min_height = '250px';
