...
<div class="cardapio-app-wrapper">
        ...
        <div id="mealPlan">
            ...
            foreach ($dias_labels as $day_key => $day_info) : 
                ...
                $meals_config = array(
                    ...
                    'lanche' => array('label' => 'Lanche', 'icon' => 'fas fa-cookie-bite', 'time' => '16:00'),
    ...
    <nav class="bottom-nav">
        <a href="#" class="nav-item active" onclick="changeView('cardapio')">
            <i class="fas fa-calendar-alt nav-icon"></i>
            <span class="nav-label">Cardápio</span>
        </a>
        <button class="nav-item" onclick="openFullShoppingList()">
            <i class="fas fa-shopping-basket nav-icon"></i>
            <span class="nav-label">Lista</span>
        </button>
        <a href="<?php echo home_url('/loja'); ?>" class="nav-item">
            <i class="fas fa-store nav-icon"></i>
            <span class="nav-label">Loja Mary</span>
        </a>
    </nav>
