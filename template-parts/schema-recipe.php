...
$schema = [
    ...
    "author" => [
        ...
        "name" => $author_name,
        "url" => $author_url,
        "description" => "Mary Rodrigues é a mente por trás do Descomplicando Receitas. Com mais de 20 anos de experiência dedicados ao domínio da culinária prática, sua missão é democratizar a gastronomia, provando que qualquer pessoa pode preparar refeições incríveis com ingredientes simples.",
        "image" => [
            "@type" => "ImageObject",
            "url" => $author_avatar
        ]
